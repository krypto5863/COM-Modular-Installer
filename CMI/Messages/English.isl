...
ReiPatcher=We discovered files that indicate you've previously or currently have reipatcher installed in your game! This isn't good and the total removal process isn't something we can easily automate.%nEither reinstall your game or contact the Meido Discord Server for help on the complete removal of ReiPatcher.
