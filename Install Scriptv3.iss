...
OutputBaseFilename=COM Modular Installer 2.3.42
...
Name: Patchers; Description: Patchers; types: full compact eng pic self hen;
  ...
  Name: Patchers/blinkstop; Description: EditBlinkStop;
...
Source: "Documentation\CMI_Readme.html"; DestDir: "{app}\CMI Documentation"; Flags: isreadme
...
//Prevents code from running if not on the directory selection page
  ...
  begin
    //path := ExpandConstant('{app}');
    if VersionCheck(WizardForm.DirEdit.Text,1470) then
    begin
