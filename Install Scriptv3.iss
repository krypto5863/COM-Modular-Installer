...
OutputBaseFilename=COM Modular Installer 2.3
...
Name: Loader; Description: Mod Loader (Required for just about everything); Types: full compact;
  Name: Loader/bepinEX; Description: BepInEX (Recommended); Types: full compact eng pic self hen; Flags:Exclusive checkablealone
    ...
    Name: Loader/bepinEX/Translations; Description: Translation Plugins; Types: Full compact pic self hen; Flags: dontinheritcheck;
      ...
      Name: Loader/bepinEX/Translations/xuat; Description: XUnity AutoTranslator; Types: full compact pic self hen; Flags: dontinheritcheck;
    ...
    Name: Loader/bepinEX/scriptloader; Description: ScriptLoader; Types: Full compact eng pic self hen; Flags: dontinheritcheck;
      Name: Loader/bepinEX/scriptloader/dedupe; Description: Dedupe Items Script; Types: Full compact eng pic self hen; Flags: dontinheritcheck;
      ...
      Name: Loader/bepinEX/scriptloader/thumbs; Description: LoadSmallThumbs Script; Types: Full; Flags: dontinheritcheck;
...
Name: Patchers; Description: Patchers; types: full compact eng pic self hen;
  ...
  Name: Patchers/allprivate; Description: AllMaidsInPrivateMode; Types: full compact self eng hen;
  ...
  Name: Patchers/cacheedit; Description: CacheEditMenu; Types: ;
  ...
  ;Name: Patchers/prelabellite; Description: PresetLabeler(NoOverlays); Types: full compact self pic eng hen; Another plugin can do the same function
  Name: Patchers/quickedit; Description: QuickEdit; Types: full pic self eng hen;
  Name: Patchers/rgbpal; Description: RGBPalette; Types:;
  Name: Patchers/saveset; Description: SaveSettingsInGame; Types: full compact self pic eng hen;
  Name: Patchers/smoothanim; Description: SmoothAnimation; Types: full self pic eng hen;
...
Name: plugins; Description: Unityinjector Plugins; Types: full compact;
  ...
  Name: plugins/nyou; Description:CustomNyou(Why...); Types:;
  Name: plugins/dancecamadjust; Description:DanceCameraAdjust; Types:;
  Name: plugins/distort; Description: DistortCorrect; Types:full self pic eng hen;
  ...
  Name: plugins/editundo; Description:EditSceneUndo; Types:;
  ...
  Name: plugins/EyelashesAlpha; Description:EyelashesAlpha; Types:full self pic eng hen;
  ...
  Name: plugins/hudclock; Description:HudClock; Types:;
  Name: plugins/inout; Description:InOutAnimation; Types:full eng hen;
  Name: plugins/lookmaid; Description:LookAtYourMaid; Types:;
  Name: plugins/lookmaster; Description:LookAtYourMaster; Types:;
  ...
  Name: plugins/ureye; Description:UruuruEye; Types:self;
  Name: plugins/vibemaid; Description:VibeYourMaid; Types:full;
...
Name: misc; Description: Miscelleanous Files; Types: full compact;
  Name:misc/mmposes; Description:1900 Poses for MM;
...
Source: "Xuat\Bep\*"; DestDir: "{app}"; Components: Loader/bepinEX/Translations/xuat; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Scripts\dedupe\*"; DestDir: "{app}\scripts"; Components: Loader/bepinEX/scriptloader/dedupe; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Plugins\distortcorrect\*"; DestDir: "{app}\Sybaris"; Components: plugins/distort; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Plugins\Lashalpha\*"; DestDir: "{app}\Sybaris"; Components: plugins/eyelashesalpha; Flags: ignoreversion recursesubdirs
...
Source: "Plugins\shapeanim\*"; DestDir: "{app}\Sybaris"; Components: plugins/shapeanimator; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Misc\MMPoses\*"; DestDir: "{app}\Mod"; Components: misc/mmposes; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Misc\TextureUncensors\MaleUncensor\*"; DestDir: "{app}\Mod\[CMI]Uncensors\MaleUncensor"; Components: misc/uncensormale; Flags: ignoreversion recursesubdirs createallsubdirs
...
Source: "Documentation\CMI_Readme.html"; DestDir: "{app}\Sybaris"; Flags: isreadme
...
//Prevents code from running if not on the directory selection page
  ...
  begin
    //path := ExpandConstant('{app}');
    if VersionCheck(WizardForm.DirEdit.Text,1440) then
    begin
  ...
  case CurStep of
    ...
    begin
      ...
      begin
        ...
        DelTree(path+'\OldInstall', True, True, True);      
        CreateDir(path+'\OldInstall');

        if MoveOld(path) = false then
        begin
          MsgBox('An exception was tossed while trying to move the old installation to the old folder! Ensure that no game application is open and that none of the files or folders are open anywhere!! We are quitting to keep your data safe!', mbCriticalError, MB_OK);
          abort       
        end;
      end;
      ...
      if WizardForm.TasksList.Checked[4] then
        begin
          ...
          CreateDir(path+'\OldInstall\Mod');
          if MoveOldMod(path) = false then
          begin
            MsgBox('An exception was tossed while trying to move the old mods to the old folder! Ensure that no game application is open and that none of the files or folders are open anywhere!! We are quitting to keep your data safe!', mbCriticalError, MB_OK);
            abort
          end;
        end;//Mod Move
      end;
